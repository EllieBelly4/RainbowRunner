...
var luaDRObjectMethods = map[string]lua2.LGFunction{
	...
	"gcType":                       luaGenericGetSetString[DRObject](func(v DRObject) *string { return &v.GetGCObject().GCType }),
	"gcLabel":                      luaGenericGetSetString[DRObject](func(v DRObject) *string { return &v.GetGCObject().GCLabel }),
	"gcNativeType":                 luaGenericGetSetString[DRObject](func(v DRObject) *string { return &v.GetGCObject().GCNativeType }),
